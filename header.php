...
<body class="<?= str_replace('.php', '', get_page_template_slug()) ?>">
        ...
        include('assets/testimony_style.php');
    ...
    <?php elseif (is_home() || is_single() && !is_single(get_post_type('temoignage'))) : ?>
        <div class="page-header d-flex align-items-center justify-content-center" style="background-image: url(<?= get_the_post_thumbnail_url($bannerBlog) ?>)"></div>
    <?php else : ?>
